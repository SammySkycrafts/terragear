...
{
public:
    Parser(const std::string& datafile, const std::string& root, const string_list& elev_src) : prev_node(nullptr),
                                                                                                filename(datafile),
                                                                                                elevation(elev_src),
                                                                                                work_dir(root),
                                                                                                cur_airport(nullptr),
...
private:
    ...
    // a polygon consists of an array of contours
    // (first is outside boundary, remaining are holes)
